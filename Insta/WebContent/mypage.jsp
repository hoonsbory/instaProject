				...
				<div class="profile-user">
					...
					<div class="profile-stats">
						...
						<ul>
							...
							<li id="followerlist"><span class="profile-stat-count">${follower}</span> 팔로워</li>
							<div>
							<div class="followerlist_class"></div>
							<div class="followerlist_div"></div>
						</div>
							<li id="followlist"><span class="profile-stat-count">${follow}</span> 팔로잉</li>
							<div>
