		...
		<div class="header_div3">
			<div class="top_menu">
				<div class="top_left">
					<a class="top_left_a" href="./">
						<div class="top_left_div1">
							...
							<div class="title">
								<span class="top_left_icon2" aria-label="Instagram"><img id="instagram" src="https://i.imgur.com/ODfS3Zz.png"></span>
							</div>
						</div>
					</a>
				</div>
				<div class="top_mid">
					...
					<span class="search_span"><img id="search_img" src="https://i.imgur.com/dxQeZSn.png"></span>
					<div class="dialog" role="dialog" tabindex="0"></div>
					<div class="search" role="button"></div>
					<div>
					<div class="shape" id="shape_mid"></div>
						<div class="searchScroll" id="scroll_mid"></div>
						</div>
				</div>
				<div class="top_right">
					<div class="top_right_div1">
						<div class="icon" id="hearticon">
							<a class="like_account">
								<span class="heart" aria-label="활동 피드 "><img id="heart" src="https://i.imgur.com/wQeFSv5.png"></span>
							</a>
						</div>
						<div>
				</div>
					...
					<div class="shape" id="shape_like"></div>
						<div class="searchScroll" id="scroll_like"></div>
						</div>
					</div>
				</div>
			</div>
