...
public class UsersDAO {
	...
	public  static JSONArray searchusers(String str) throws Exception { //유저 검색
		String sql = "select name, img , email,id from users where lower(name) like ? or lower(email) like ?";
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
